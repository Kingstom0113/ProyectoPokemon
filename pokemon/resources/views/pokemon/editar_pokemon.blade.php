...
<!--Aqui aparece un formulario donde puedes editar un pokemon ya creado-->
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <div class="container">
                            <h1 class="text-center">Editar Pokemon</h1>

                            <form id="formulario_pokemon_edicion" method="post"
                                action="{{ route('actualizar_pokemon', ['id' => $pokemon->id]) }}"> @csrf
                                @method('PUT')

                                <div class="mb-3">
                                    <label for="pokedex" class="form-label">Número de la Pokédex</label>
                                    <input type="number" class="form-control" id="pokedex" name="pokedex"
                                        value="{{ $pokemon->pokedex }}" required>
                                </div>
